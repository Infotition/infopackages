...
<div align="center">
  ...
  <h3 align="center">Create Splash Animation</h3>

  <p align="center">
    An lightweight utility package for material design like splash animations.
    <br />
    <a href="https://infotition.github.io/infopackages/category/create-splash-animation"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://www.npmjs.com/package/@infotition/create-splash-animation">View Package</a>
    ·
...
To see this package in action, you can visit the docs of the [react-button](https://infotition.github.io/infopackages/category/react-button) component.
...
At this point everything ist installed. Now change your directory to the splash animation  utility.

```bash
cd infopackages/packages/create-splash-animation
```
